...
column1 = dbc.Col(
    [
        dcc.Markdown(
            ...
            With this app you can predict the 2015 energy demand for the Dayton, Ohio region for Dayton Power 
            ...
            you can see the values for individual observations by hovering with your cursor. You can zoom 
